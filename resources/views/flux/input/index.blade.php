...
$classes = Flux::classes()
    ...
    ->add(match ($variant) { // Text color
        'outline' => 'text-zinc-950 disabled:text-zinc-500 placeholder-zinc-400 disabled:placeholder-zinc-400/70 dark:text-white dark:disabled:text-zinc-400 dark:placeholder-zinc-400 dark:disabled:placeholder-zinc-500',
