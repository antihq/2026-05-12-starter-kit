...
$classes = Flux::classes()
    ...
    ->add('[&:not(:has([data-flux-field])):has([data-flux-control][disabled])>[data-flux-description]]:opacity-50') // Dim descriptions for fields with no nested fields when a control is disabled...
